...
### 1. **GPT Paraphraser**  
Paraphrase any selected text quickly and efficiently. Just highlight the text, 
press `Cmd + Ctrl + P` to process it, and see a simplified version of the original text.
